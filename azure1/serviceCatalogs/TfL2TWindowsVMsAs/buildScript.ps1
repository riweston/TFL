...
Param(
    ...
    [string]$appDefDisplayName      = "TFL Two Tier Web + App Windows VMs in AS",
    [string]$appDefDescription      = "Non-Domain joined 2 Tier Virtual Machines (Web and App Tier) Availability Set"
)
# Constant vars
