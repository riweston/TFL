...
Param(
    ...
    [string]$appDefDisplayName      = "TFL Web + App Windows VM on Domain ",
    [string]$appDefDescription      = "Domain joined 2 Tier Virtual Machines (Web and App Tier) Availability Set"
)
# Constant vars
